--Creación de tabla Equipos con columnas: id, nombre, liga y país.
--Columna id es clave primaria que incrementa automáticamente.
--Las demás columnas son del tipo varchar (almacena cadena caracteres) que pueden tener valores no nulos.
...
--Se insertan datos en la tabla donde cada fila
--representa un equipo con su respectivo nombre, liga y pais de origen
